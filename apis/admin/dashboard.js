...
export const getRecentReports = async (size) => {
  const response = await axiosInstance.get('/api/admin/dashboard/recent-reports', {
    params: { size },
  });
  return response.data;
};
...
export const getRecentMembers = async (size) => {
  const response = await axiosInstance.get('/api/admin/dashboard/recent-members', {
    params: { size },
  });
  return response.data;
};
