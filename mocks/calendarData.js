...
// ─────────────────────────────────────────────────────────────
// 달력 막대 모양 확인용 데이터. /calendar/mock 에서만 쓰인다. (개발 환경 전용 페이지)
// 실제 화면은 GET /api/event 를 조회하고 실패해도 목 데이터로 메꾸지 않으므로(CalendarSection)
// 이 파일의 값은 실제 화면에 영향을 주지 않는다.
//
// content('세부 내용')는 여러 줄 문자열이다. '-'로 시작하면 목록, 앞의 공백 2칸마다
// 한 단계 들여쓴다. (ScheduleDetailContent 참고)
