...
import { DUMMY_POSTS_NOTICES, DUMMY_POSTS_FREE } from '@/mocks/top4Data';
import { ArrowRight } from 'lucide-react';

// 게시판 4개 노출

function BoardList({ title, posts, boardType }) {
    ...
    <div className="flex flex-col gap-[10px] w-full lg:w-[424.5px]">
      ...
      <div className="flex flex-col w-full border-t border-[#B9B9B9]">
        {posts.map((post, index) => (
          <div
            key={post.postId}
            onClick={() => router.push(`/${boardType}/${post.postId}`)}
