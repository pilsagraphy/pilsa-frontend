...
export default function PenaltyStatCard({ value, label }) {
  return (
    <div className="flex min-h-[76px] w-full flex-col items-center justify-center gap-[2px] rounded-[12px] border border-[#919191] bg-white px-[12px] py-[12px] text-center font-['Pretendard',sans-serif] sm:min-h-[87px] sm:gap-[4px]">
      ...
      <span className="break-keep text-[12px] font-normal leading-[1.5] tracking-[-0.24px] text-[#212121] sm:text-[14px] sm:tracking-[-0.28px]">
        {label}
      </span>
    </div>
  );
