...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <div className="absolute right-[-4px] top-[48px] z-[70] w-[320px] max-w-[calc(100vw-16px)] overflow-hidden rounded-[12px] border border-black/10 bg-white shadow-[0_8px_30px_rgba(0,0,0,0.12)] md:right-[-16px] lg:right-[-80px]">
